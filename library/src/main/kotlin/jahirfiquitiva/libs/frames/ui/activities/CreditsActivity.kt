...
open class CreditsActivity : ThemedActivity<FramesKonfigs>() {
    ...
    open fun getTranslationSite(): String = "#"
    ...
    private fun buildCreditsList(): ArrayList<Credit> {
        ...
        try {
            ...
            list.add(
                Credit(
                    "Ab", AB_PHOTO_URL, Credit.Type.DASHBOARD,
                    description = getString(R.string.dashboard_copyright),
                    buttonsTitles = AB_BUTTONS.split("|"),
                    buttonsLinks = AB_LINKS.split("|")))
    ...
    private companion object {
       const val AB_PHOTO_URL =
            "https://goo.gl/mCa9tW"
        const val AB_BUTTONS = "Twitter|Website|Github"
        const val AB_LINKS =
            "https://www.twitter.com/abdarker/|https://abdarker.github.io|https://github.com/abdarker"
